...
import VotingTimer from "@/features/games/spy/lobby/layout/VotingTimer";
...
useEffect(() => {
  ...
  // Extra 10-second breathing time after
  // the round-intro card finishes.
